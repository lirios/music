...
#include <memory>
#include "../../../../src/Components/Songs/songmodel.h"
...
QT_MOC_LITERAL(1, 10, 15), // "getSongsByAlbum"
QT_MOC_LITERAL(2, 26, 15), // "QList<QObject*>"
QT_MOC_LITERAL(3, 42, 0), // ""
QT_MOC_LITERAL(4, 43, 2), // "id"
QT_MOC_LITERAL(5, 46, 16), // "getSongsByArtist"
QT_MOC_LITERAL(6, 63, 9), // "getArtist"
QT_MOC_LITERAL(7, 73, 8), // "getAlbum"
QT_MOC_LITERAL(8, 82, 11) // "getAllSongs"

    },
    "SongModel\0getSongsByAlbum\0QList<QObject*>\0"
    "\0id\0getSongsByArtist\0getArtist\0getAlbum\0"
    "getAllSongs"
};
...
static const uint qt_meta_data_SongModel[] = {
 ...
 // methods: name, argc, parameters, tag, flags
       ...
       6,    1,   45,    3, 0x02 /* Public */,
       7,    1,   48,    3, 0x02 /* Public */,
       8,    0,   51,    3, 0x02 /* Public */,
...
void SongModel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: { QList<QObject*> _r = _t->getSongsByAlbum((*reinterpret_cast< int(*)>(_a[1])));
            if (_a[0]) *reinterpret_cast< QList<QObject*>*>(_a[0]) = std::move(_r); }  break;
        case 1: { QList<QObject*> _r = _t->getSongsByArtist((*reinterpret_cast< int(*)>(_a[1])));
            if (_a[0]) *reinterpret_cast< QList<QObject*>*>(_a[0]) = std::move(_r); }  break;
        case 2: { QString _r = _t->getArtist((*reinterpret_cast< int(*)>(_a[1])));
            if (_a[0]) *reinterpret_cast< QString*>(_a[0]) = std::move(_r); }  break;
        case 3: { QString _r = _t->getAlbum((*reinterpret_cast< int(*)>(_a[1])));
            if (_a[0]) *reinterpret_cast< QString*>(_a[0]) = std::move(_r); }  break;
        case 4: { QList<QObject*> _r = _t->getAllSongs();
            if (_a[0]) *reinterpret_cast< QList<QObject*>*>(_a[0]) = std::move(_r); }  break;
        default: ;
        }
    }
